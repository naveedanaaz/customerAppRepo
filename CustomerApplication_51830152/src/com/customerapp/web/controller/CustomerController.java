...
public class CustomerController {
	...
	public String updateCustomerGet(HttpServletRequest req, ModelMap map) {
		int customerId = Integer.parseInt(req.getParameter("id"));
		Customer customerIdToBeUpdate = customerService.getCustomerById(customerId);
		System.out.println(customerIdToBeUpdate);
		map.addAttribute("customer", customerIdToBeUpdate);
		return "addcustomer";
	}
