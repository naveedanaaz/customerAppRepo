...
public class UserMgtController {
	...
	//@PostConstruct
	public void init() {
		userService.addUser(new User("naaz", "naaz@n.com", "naaz123", "admin",
				true));
		userService.addUser(new User("sahil", "sahil@s.com", "sahil123", "mgr",
				true));
		userService.addUser(new User("begum", "begum@b.com", "begum123",
				"emp", true));
	}
